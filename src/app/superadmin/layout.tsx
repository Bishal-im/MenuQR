  ...
  return (
    <div className="min-h-screen bg-black flex transition-all duration-500">
      ...
      <main className="flex-grow ml-72 min-h-screen flex flex-col relative overflow-hidden">
          ...
          <form onSubmit={handleSearch} className="flex items-center gap-4 flex-grow max-w-xl">
            <div className="relative w-full group">
              ...
              <input 
                ...
                className="w-full bg-neutral-900/50 border border-neutral-800 rounded-xl py-2.5 pl-12 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-primary/50 focus:border-primary transition-all placeholder:text-neutral-600"
              />
            </div>
          </form>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-2 group">
              <div className="text-right flex flex-col">
                <span className="text-sm font-black text-white group-hover:text-primary transition-colors">{user.name || "Admin Root"}</span>
                <span className="text-[10px] text-neutral-500 font-bold uppercase tracking-widest">Platform Owner</span>
              </div>
              <div className="w-10 h-10 bg-gradient-to-tr from-primary to-primary/80 rounded-xl flex items-center justify-center text-white border-2 border-neutral-800/50 shadow-xl group-hover:scale-105 transition-all">
        ...
        <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-primary/5 rounded-full blur-[120px] pointer-events-none -z-10" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[30%] h-[30%] bg-primary/5 rounded-full blur-[100px] pointer-events-none -z-10" />
      </main>
    </div>
  );
}

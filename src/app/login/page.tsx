...
export default function SuperAdminLoginPage() {
  ...
  const handleOTPSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.success) {
        setSuccess("OTP Verified! Connecting...");
        await refreshUser();
      } else {
        ...
        <div className="bg-neutral-900/50 backdrop-blur-3xl border border-neutral-800 p-8 rounded-[2.5rem] shadow-2xl">
          <div className="text-center mb-10">
            ...
            <p className="text-neutral-500 text-sm font-medium">
              {step === "email" 
                ? "Enter your secure email to receive a login code." 
              ...
              <>
                ...
                <div className="flex items-center justify-between px-2">
                  <p className="text-[10px] font-black uppercase tracking-widest text-neutral-600">
                    Code expires in: <span className={timer < 30 ? "text-red-500" : "text-orange-500"}>

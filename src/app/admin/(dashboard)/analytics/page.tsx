    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-border bg-card p-8">
           ...
           <div className="flex items-end justify-between h-48 gap-2">
              {(stats?.revenueTrend || [0, 0, 0, 0, 0, 0, 0]).map((h: number, i: number) => (
      ...
      <div className="rounded-2xl border border-border bg-card p-8">
         <h3 className="font-bold flex items-center gap-2 mb-6">
           <Clock className="h-4 w-4 text-primary" /> Hourly Orders (Today)
         </h3>
         <div className="flex items-end justify-between h-32 gap-1 overflow-x-auto pb-4 custom-scrollbar">
            {(stats?.hourlyOrders || new Array(12).fill(0)).map((h: number, i: number) => {
              return (
